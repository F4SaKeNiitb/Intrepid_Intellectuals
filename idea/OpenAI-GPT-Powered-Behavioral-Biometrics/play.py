...
def train_model(features, labels):
    ...
    # Split into training and test sets with explicit shuffling
...
def main():
    ...
    print("User1: Please type for 30 seconds...")
    keystrokes1 = collect_keystroke_data(duration=30)
    print("User2: Please type for 30 seconds...")
    keystrokes2 = collect_keystroke_data(duration=30)
    
    features_user1 = extract_features(keystrokes1)
    features_user2 = extract_features(keystrokes2)
    
    # Create labels for each feature sample
    user1_labels = ['user1'] * len(features_user1)
    user2_labels = ['user2'] * len(features_user2)
    
    features = features_user1 + features_user2
    user_labels = user1_labels + user2_labels
    ...
    print("Authentication: Please type for 20 seconds...")
